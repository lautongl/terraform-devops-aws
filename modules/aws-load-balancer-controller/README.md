...
| [aws_iam_role_policy_attachment.eks-controller-role-attachment](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| <a name="input_oidc"></a> [oidc](#input\_oidc) | https url oidc eks cluster | `string` | n/a | yes |
